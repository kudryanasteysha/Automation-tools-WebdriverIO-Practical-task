...
describe ("Create a New Paste", function (){
    ...
    it ("should add a new paste (I Can Win)", async function() {
        // open the main url and verify the title
        await MainPage.open();
        ...
        await browser.saveScreenshot('./screens/screenshot1.png');
    })
    ...
    it ("should add a new paste (Bring It On)", async function() {
        ...
        //await MainPage.enterTextPasteInput('git config');
       ...
       // take a screenshot of the result
       await browser.saveScreenshot('./screens/screenshot2.png');
